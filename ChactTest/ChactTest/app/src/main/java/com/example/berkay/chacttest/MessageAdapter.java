...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder> {
    ...
    public class MessageViewHolder extends RecyclerView.ViewHolder {
        ...
        public MessageViewHolder(View view) {
            ...
            profileImage = (CircleImageView) view.findViewById(R.id.message_profil_layout);
    ...
    public void onBindViewHolder(final MessageViewHolder viewHolder, int i) {
        ...
        mUserDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(viewHolder.profileImage.getContext())
                        .load(image).placeholder(R.drawable.kisi_varsayilan)
        ...
        if (message_type.equals("text")) {
            ...
            Picasso.with(viewHolder.messageImage.getContext()).
                    load(c.getMessage()).into(viewHolder.messageImage);
            viewHolder.messageImage.setVisibility(View.VISIBLE);
            Log.d("RESIMMMMMMM", c.getMessage());
        }
    }
