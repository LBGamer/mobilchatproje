...
public class ChatsFragment extends Fragment {
    ...
    private DatabaseReference mAllMessageDatabase;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAllMessageDatabase = FirebaseDatabase.getInstance().getReference().child("messages");
    ...
    public static class ConvViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setUserImage(String thumb_image, Context ctx) {
            ...
            CircleImageView userImageView = (CircleImageView) mView.findViewById(R.id.user_signle_image);
